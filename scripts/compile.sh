...
# Arrays to track NeuroTIC and user headers
declare -a NTIC_INCLUDES
declare -a USR_INCLUDES

# Parse #include directives in main project file
...
# Resolve recursive NeuroTIC dependencies
i=0
...
# Compile NeuroTIC source files into object files
...
# Resolve user dependencies recursively
i=0
...
# Compile user source files into object files
